...
class EventTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.invalid_organizer = Organizer.objects.create(
            company_name="Invalid Date Corp",
            password="strongpass123",
            email="invaliddate@corp.com",
            phone="0987654321",
            cnpj="58.675.412/0007-15"
        )
    ...
    def test_create_event_invalid_date(self):
        data = {
            ...
            "organizer": self.invalid_organizer.pk
        }
